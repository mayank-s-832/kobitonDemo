...
public class Reporting  {
	...
	public Reporting(AppiumDriver<WebElement> driver, String browserCode){
	...
	public void logStepToReport(Status status, String Details, String filenamePath,WebElement element) {
